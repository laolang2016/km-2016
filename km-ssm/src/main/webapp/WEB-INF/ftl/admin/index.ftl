...
<head>
    ...
    <link href="http://static.km-ssm-dev.com/admin/hplus/css/bootstrap.min.css?v=3.3.7" rel="stylesheet" />
    <link href="http://static.km-ssm-dev.com/admin/hplus/css/font-awesome.min.css?v=4.4.0" rel="stylesheet" />
    <link href="http://static.km-ssm-dev.com/admin/hplus/css/animate.css" rel="stylesheet" />
    <link href="http://static.km-ssm-dev.com/admin/hplus/css/style.css?v=4.1.0" rel="stylesheet" />
    <link href="http://static.km-ssm-dev.com/admin/hplus/css/jquery.contextMenu.min.css" rel="stylesheet"/>
</head>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="http://static.km-ssm-dev.com/admin/hplus/img/profile_small.jpg" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a class="J_menuItem" href="form_advanced.html">高级插件</a></li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li><a class="J_menuItem" href="form_editors.html">富文本编辑器</a></li>
                                <li><a class="J_menuItem" href="form_simditor.html">simditor</a></li>
                                <li><a class="J_menuItem" href="form_markdown.html">MarkDown编辑器</a></li>
                                <li><a class="J_menuItem" href="code_editor.html">代码编辑器</a></li>
                            </ul>
                        </li>
                        <li><a class="J_menuItem" href="suggest.html">搜索自动补全</a></li>
                        <li><a class="J_menuItem" href="layerdate.html">日期选择器layerDate</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a class="J_menuItem" href="social_feed.html">信息流</a></li>
                        <li><a class="J_menuItem" href="clients.html">客户管理</a></li>
                        <li><a class="J_menuItem" href="file_manager.html">文件管理器</a></li>
                        <li><a class="J_menuItem" href="calendar.html">日历</a></li>
                        <li>
                            <a href="#">博客 <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li><a class="J_menuItem" href="blog.html">文章列表</a></li>
                                <li><a class="J_menuItem" href="article.html">文章详情</a></li>
                            </ul>
                        </li>
                        <li><a class="J_menuItem" href="faq.html">FAQ</a></li>
                        <li>
                            <a href="#">时间轴 <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li><a class="J_menuItem" href="timeline.html">时间轴</a></li>
                                <li><a class="J_menuItem" href="timeline_v2.html">时间轴v2</a></li>
                            </ul>
                        </li>
                        <li><a class="J_menuItem" href="pin_board.html">标签墙</a></li>
                        <li>
                            <a href="#">单据 <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li><a class="J_menuItem" href="invoice.html">单据</a></li>
                                <li><a class="J_menuItem" href="invoice_print.html">单据打印</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li><a class="J_menuItem" href="chat_view.html">聊天窗口</a></li>
                                <li><a class="J_menuItem" href="webim.html">layIM</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">登录注册相关 <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li><a href="login.html" target="_blank">登录页面</a></li>
                                <li><a href="login_v2.html" target="_blank">登录页面v2</a></li>
                                <li><a href="register.html" target="_blank">注册页面</a></li>
                                <li><a href="lockscreen.html" target="_blank">登录超时</a></li>
                            </ul>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="table_bootstrap.html">Bootstrap Table <span class="label label-danger pull-right">推荐</span></a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="http://static.km-ssm-dev.com/admin/hplus/img/a7.jpg" />
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="http://static.km-ssm-dev.com/admin/hplus/img/a4.jpg" />
                                    </a>
                                    <div class="media-body">
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="http://static.km-ssm-dev.com/admin/hplus/img/a1.jpg" />
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="http://static.km-ssm-dev.com/admin/hplus/img/a2.jpg" />
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="http://static.km-ssm-dev.com/admin/hplus/img/a3.jpg" />
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="http://static.km-ssm-dev.com/admin/hplus/img/a4.jpg" />
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="http://static.km-ssm-dev.com/admin/hplus/img/a8.jpg" />
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="http://static.km-ssm-dev.com/admin/hplus/img/a7.jpg" />
                                </div>
                                <div class="media-body">
...
<!-- 全局js -->
<script src="http://static.km-ssm-dev.com/admin/hplus/js/jquery.min.js?v=2.1.4"></script>
<script src="http://static.km-ssm-dev.com/admin/hplus/js/bootstrap.min.js?v=3.3.7"></script>
<script src="http://static.km-ssm-dev.com/admin/hplus/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="http://static.km-ssm-dev.com/admin/hplus/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="http://static.km-ssm-dev.com/admin/hplus/js/plugins/contextMenu/jquery.contextMenu.min.js"></script>
<script src="http://static.km-ssm-dev.com/admin/hplus/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="http://static.km-ssm-dev.com/admin/hplus/js/hplus.js?v=4.1.0"></script>
<script type="text/javascript" src="http://static.km-ssm-dev.com/admin/hplus/js/contabs.js"></script>

<!-- 第三方插件 -->
<script src="http://static.km-ssm-dev.com/admin/hplus/js/plugins/pace/pace.min.js"></script>

<!-- km js -->
<script src="http://static.km-ssm-dev.com/admin/km/common.js"></script>
</body>
</html>
